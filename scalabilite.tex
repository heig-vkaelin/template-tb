...
Pour conclure, avec la version initiale de \gls{beeplace}, le test est exécuté pendant environ \textbf{19 secondes} en créant \textbf{558 utilisateurs virtuels} qui dessinent au total \textbf{1017 pixels}.
