...
Les résultats pour la version initiale sont différents de ceux présentés dans le tableau \ref{table:k6-initial-results} car le test a été relancé pour pouvoir comparer les résultats avec l'optimisation au même moment. Ces différences prouvent l'importance du système permettant de changer rapidement l'image Docker avec des tags.
