...
Comme discuté rapidement dans le chapitre "Proof of concept" \ref{poc}, il est nécessaire de pouvoir diviser l'affichage de l'application sur plusieurs écrans afin de pouvoir être projetée sur les tours de l'école. Ce mode est implémenté en deux parties:
